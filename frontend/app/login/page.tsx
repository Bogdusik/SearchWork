      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/[0.04] border border-white/[0.08] backdrop-blur-sm rounded-2xl p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.08] text-white/80 hover:text-white font-medium py-2.5 rounded-lg transition-all text-sm"
          >
            <GoogleIcon />
